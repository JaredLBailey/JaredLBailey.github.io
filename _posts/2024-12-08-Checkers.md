...
STL files were obtained from Will Cogley (<a href="eyes https://willcogley.notion.site/Will-Cogley-Project-Archive-75a4864d73ab4361ab26cabaadaec33a>animatronic eyes</a>) and Fanki the Printer (<a href="https://makerworld.com/en/models/657234#profileId-584358">model of daughters teeth</a>). The printed output from Will’s STL files did not fit properly, due to many issues with tolerances. This required multiple adjustments and reprints for proper function. The teeth mold was not designed for animatronic use, and was thus modified to allow for the desired movement by my teammate Kaelyn.
