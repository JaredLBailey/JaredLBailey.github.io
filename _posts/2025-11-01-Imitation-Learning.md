...
This project explores creative tool use in robotics through an imitation learning policy. Specifically, I trained a robot arm to both position and cut a food item using a single one degree of freedom tool - a pair of scissors mounted on a custom end effector.
...
Additional tool interfaces were explored for pliers, a can opener, and rod-based tools like a screwdriver. These mechanisms made use of cinchable bungee cords, allowing the user to swap tools in and out at a moment's notice.
